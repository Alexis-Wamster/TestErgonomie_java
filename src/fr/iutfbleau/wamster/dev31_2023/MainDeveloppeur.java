...
/** 
 * <code>MainDeveloppeur</code> controlleur principal qui lance l'execution du programme du developpeur
 * @version 1.1
 * @author Djabrail KHAPIZOV et Alexis WAMSTER
*/

public class MainDeveloppeur{
	/** 
 	* Lancement du programme en affichant une fenetre sur un menu ou il faut selectionner un protocole
	*/
    public static void main(String[] args){
		CProgramme typeProgramme = CProgramme.RESULTAT;
